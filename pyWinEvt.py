# Thanks to the following libary source to enable my Win32 Event log dump
...
def getEventLogs(server, logtype, logPath):
    ...
    named log file
    """
    print "WinEvt: Logging {} events".format(logtype)
    ...
    print "WinEvt: Total events in {} = {}".format(logtype, total)
    ...
    print "WinEvt: Dumping ({}) is finished.".format(os.path.basename(logPath))
